...
- (void)viewDidLoad {
    ...
    //avviso che ha terminato la lettura dei dati
...
-(void)wiewWillAppear:(BOOL)animated {
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {    return self.scoreArray.count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    Risultato *ris = self.scoreArray[indexPath.row];
    // Configure the cell...
    NSString *text = [NSString stringWithFormat:@"Row %li - Score %li", (long)indexPath.row,ris.score];
    NSLog(@"%li", ris.score);
